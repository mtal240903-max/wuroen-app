...
import { 
  ...
  Alert, ActivityIndicator, ScrollView, StatusBar, KeyboardAvoidingView, Platform, useWindowDimensions 
} from 'react-native';
import axios from 'axios';
import { COLORS } from '../../theme/theme';
import { AuthContext } from '../../context/AuthContext';
import { User, Mail, Lock, BookOpen, UserPlus, ArrowLeft, Award } from 'lucide-react-native';
    ...
    >
      ...
      <View style={[styles.mainLayout, isLargeScreen && styles.rowLayout]}>
          ...
          <View style={styles.leftSidebar}>
            <View style={styles.sidebarContent}>
              <View style={styles.sidebarIconCircle}>
                <Award color={COLORS.primary} size={40} />
              </View>
              <Text style={styles.sidebarTitle}>Rejoignez la communauté</Text>
              <Text style={styles.sidebarSubtitle}>
                Créez votre compte pour partager vos documents, échanger avec d'autres chercheurs et centraliser vos connaissances techniques.
              </Text>
              <View style={styles.sidebarFooter}>
                <Text style={styles.sidebarFooterText}>WURO'EN PROTOCOL v2.0</Text>
              </View>
            </View>
          </View>
        )}

        {/* COMPOSANT CENTRAL / DROIT DÉFILANT */}
        <ScrollView 
        ...
        >
          ...
          {/* Masqué sur PC car présent dans la barre latérale */}
          {!isLargeScreen && (
...
const styles = StyleSheet.create({
  ...
  sidebarContent: { width: '100%', maxWidth: 400, alignItems: 'center' },
  ...
  sidebarTitle: { fontSize: 28, fontWeight: '900', color: '#FFF', marginBottom: 15, textAlign: 'center' },
  sidebarSubtitle: { fontSize: 14, color: '#64748B', textAlign: 'center', lineHeight: 22 },
  sidebarFooter: { position: 'absolute', bottom: -150 },
  sidebarFooterText: { color: '#334155', fontSize: 11, fontWeight: '700', letterSpacing: 2 },

  // Volet droit défilant
  scrollContent: { flexGrow: 1, padding: 30, paddingTop: 60 },
  scrollContentDesktop: { justifyContent: 'center', alignItems: 'center', paddingVertical: 40, backgroundColor: '#020617' },
